...
class Amulet3 extends StatefulWidget {
  @override
  _Amulet3State createState() => _Amulet3State();
}
...
class _Amulet3State extends State<Amulet3> {
  @override
          ...
          Stack(
            children: [
              Container(
                  ...
                  child: FittedBox(
                      fit: BoxFit.fill,
                      child: Image(image: AssetImage('images/Frame3.png')))),
              Positioned(
                  top: 280,
                  left: 90,
                  child: Text(
