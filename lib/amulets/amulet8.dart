...
class Amulet8 extends StatefulWidget {
  @override
  _Amulet8State createState() => _Amulet8State();
}
...
class _Amulet8State extends State<Amulet8> {
  @override
          ...
          Stack(
            children: [
              Container(
                  ...
                  child: FittedBox(
                      fit: BoxFit.fill,
                      child: Image(image: AssetImage('images/Frame8.png')))),
              Positioned(
                  top: 30,
                  left: 55,
                  child: Text(
                    "42576665318157123\n35176789751721631".toUpperCase(),
