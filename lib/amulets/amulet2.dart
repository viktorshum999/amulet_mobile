...
class Amulet2 extends StatefulWidget {
  @override
  _Amulet2State createState() => _Amulet2State();
}
...
class _Amulet2State extends State<Amulet2> {
  @override
          ...
          Stack(
            children: [
              Container(
                  ...
                  child: FittedBox(
                      fit: BoxFit.fill,
                      child: Image(image: AssetImage('images/Frame2.png')))),
              Positioned(
                  top: 41,
                  left: 41,
                  child: Text(
